...
var CalendarList = function (_a) {
    var pastYearRange = _a.pastYearRange, futureYearRange = _a.futureYearRange, initialNumToRender = _a.initialNumToRender, locale = _a.locale, handlePress = _a.handlePress, startDate = _a.startDate, endDate = _a.endDate, flatListProps = _a.flatListProps, isMonthFirst = _a.isMonthFirst, disabledBeforeToday = _a.disabledBeforeToday, disabledAfterToday = _a.disabledAfterToday, style = _a.style;
    ...
    var getInitialIndex = useCallback(function () {
        return months.findIndex(function (month) {
            var targetDate = startDate ? dayjs(startDate) : dayjs();
    ...
    var handleRenderItem = useCallback(function (_a) {
        ...
        return (<View style={[
            ...
            style === null || style === void 0 ? void 0 : style.monthOverlayContainer,
        ]}>
        <Month item={item} locale={locale} handlePress={handlePress} startDate={startDate} endDate={endDate} isMonthFirst={isMonthFirst} disabledBeforeToday={disabledBeforeToday} disabledAfterToday={disabledAfterToday} style={style}/>
      </View>);
