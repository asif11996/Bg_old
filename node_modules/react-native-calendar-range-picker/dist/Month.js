...
function Month(_a) {
    var item = _a.item, locale = _a.locale, handlePress = _a.handlePress, startDate = _a.startDate, endDate = _a.endDate, isMonthFirst = _a.isMonthFirst, disabledBeforeToday = _a.disabledBeforeToday, disabledAfterToday = _a.disabledAfterToday, style = _a.style;
    ...
    var renderWeeks = function () {
        ...
        for (var i = 0; i < weeks.length; i++) {
            result.push(<Week key={i} week={weeks[i]} locale={locale} handlePress={handlePress} is6Weeks={is6Weeks} disabledBeforeToday={disabledBeforeToday} disabledAfterToday={disabledAfterToday} style={style}/>);
        }
        return result;
    };
