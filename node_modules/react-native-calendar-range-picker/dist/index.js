...
export default function Index(_a) {
    var _b = _a.pastYearRange, pastYearRange = _b === void 0 ? 1 : _b, _c = _a.futureYearRange, futureYearRange = _c === void 0 ? 2 : _c, _d = _a.initialNumToRender, initialNumToRender = _d === void 0 ? 7 : _d, _e = _a.locale, locale = _e === void 0 ? LOCALE : _e, prevStartDate = _a.startDate, prevEndDate = _a.endDate, onChange = _a.onChange, style = _a.style, singleSelectMode = _a.singleSelectMode, flatListProps = _a.flatListProps, isMonthFirst = _a.isMonthFirst, disabledBeforeToday = _a.disabledBeforeToday, disabledAfterToday = _a.disabledAfterToday;
    ...
    return (<CalendarList initialNumToRender={initialNumToRender} pastYearRange={pastYearRange} futureYearRange={futureYearRange} locale={locale} handlePress={handlePress} startDate={startDate} endDate={endDate} style={style} flatListProps={flatListProps} isMonthFirst={isMonthFirst} disabledBeforeToday={disabledBeforeToday} disabledAfterToday={disabledAfterToday}/>);
}
