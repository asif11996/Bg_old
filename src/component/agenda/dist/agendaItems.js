...
exports.getMarkedDates = exports.agendaItems = void 0;
var today = new Date().toISOString().split('T')[0];
var fastDate = getPastDate(3);
var futureDates = getFutureDates(12);
...
function getFutureDates(numberOfDays) {
    ...
    for (var index = 1; index <= numberOfDays; index++) {
        ...
        if (index > 8) {
            ...
            var newMonth = new Date(d).getMonth() + 1;
            d = new Date(d).setMonth(newMonth);
        }
        var date = new Date(d + 864e5 * index); // 864e5 == 86400000 == 24*60*60*1000
...
function getMarkedDates() {
    var marked = {};
    exports.agendaItems.forEach(function (item) {
